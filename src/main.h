...
class Context {
  public:
    ...
    Context(uint8_t numLEDs, CRGB *leds) {
        this->numLEDs = numLEDs;
        this->leds = leds;
    }
};

Context gContext(NUM_LEDS, new CRGB[NUM_LEDS]);

void FillLEDsFromPaletteColors(CRGBPalette16 currentPalette, Context &context) {
